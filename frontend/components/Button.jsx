...
const variants = {
  ...
  outline:
    "bg-white text-slate-700 border border-slate-300 hover:border-emerald-500 hover:bg-emerald-50 hover:text-emerald-700 focus-visible:ring-2 focus-visible:ring-emerald-500/30",
  ghost:
