          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
            ...
            <div className="lg:w-1/2 text-center lg:text-left">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight text-[#1F2937] mb-6">
                ...
                <span className="text-transparent bg-clip-text bg-linear-to-r from-[#0F766E] to-teal-500">Reduce Waste.</span> <br/>
                Build Impact.
              </h1>
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
                ...
                <button 
                  type="button"
                  className="w-full sm:w-auto px-8 py-4 bg-white text-[#1F2937] border border-gray-200 rounded-full font-semibold hover:border-[#0F766E] cursor-pointer hover:text-[#0F766E] transition-all flex items-center justify-center gap-2"
            ...
            <div className="lg:w-1/2 w-full flex justify-center">
              <div className="relative w-full max-w-md aspect-square">
                ...
                <div className="absolute inset-0 bg-linear-to-tr from-[#D1FAE5] to-white rounded-[2rem] shadow-2xl transform rotate-3"></div>
                <div className="absolute inset-0 bg-white/80 backdrop-blur-sm rounded-4xl border border-white shadow-xl transform -rotate-2 flex flex-col items-center justify-center p-8">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            <div className="lg:w-1/2">
              ...
              <p className="text-gray-300 text-lg mb-8 leading-relaxed">
                We believe in radical transparency. Every donation is digitally logged, ensuring that donors know exactly when their contribution reached the table. A transparent audit trail builds confidence for everyone involved.
              </p>
            ...
            <div className="lg:w-1/2 w-full">
              ...
              <div className="bg-gray-800 rounded-2xl p-8 border border-gray-700 shadow-2xl relative">
                ...
                <div className="flex items-center justify-between border-b border-gray-700 pb-4 mb-6">
                   ...
                   <span className="text-gray-500 font-mono text-sm">delivery_log.json</span>
                </div>
        ...
        <div className="container mx-auto px-4 md:px-8 text-center relative z-10">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-4">
            {!user ? (
              ...
              <button 
                type="button"
                className="w-full md:w-auto px-10 py-5 bg-[#0F766E] text-white text-lg rounded-xl font-bold hover:bg-[#0d645d] hover:-translate-y-1 transition-all shadow-xl flex items-center gap-2"
